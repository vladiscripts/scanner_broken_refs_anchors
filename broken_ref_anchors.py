...
if len(referrors.pages_with_referrors) > 0:
	file_savelines(filename_listpages_errref, referrors.pages_with_referrors)
	json_store_to_file(filename_listpages_errref_json, referrors.pages_with_referrors)

# print('list_pages_with_referrors')
# print(pages_with_referrors)
...
if edit_page_by_list:
	...
	for title in referrors.pages_with_referrors:
		refs_of_page = referrors.pages_with_referrors[title]
		refs_str = '|'.join([refs_of_page.get(ref) for ref in refs_of_page])
