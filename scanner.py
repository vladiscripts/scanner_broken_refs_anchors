...
if __name__ == '__main__':
    ...
    if do_generation_lists:
        ...
        # Запись списков
        print('*** Do save_listpages_for_remove_warning_tpls')
