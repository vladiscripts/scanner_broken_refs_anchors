...
class MakeWikiList:
	def __init__(self, pages_with_referrors, pwb_format=True, alphabet_order=True):
		...
		self.wikisections = []
		# self.letter_groups = {'АБВГДЕЁЖЗ': '[АБВГДЕЁЖЗ]', 'ИКЛМНО':'[ИКЛМНО]', 'ПH': '[ПH]', 'СТУФХЦЧШЩЪЫЬЭЮЯ': '[СТУФХЦЧШЩЪЫЬЭЮЯ]'}
		# self.letter_groups_other = {'other': r'[.]'}
		self.letter_groups = {u'АБВГД': '[АБВГД]', u'ЕЁЖЗИЙК': u'[ЕЁЖЗИЙК]', u'ЛМН': u'[ЛМН]', u'ОПР': '[ОПР]',
							  u'СТ':    u'[СТ]', u'УФХЦЧШЩЪЫЬЭЮЯ': u'[УФХЦЧШЩЪЫЬЭЮЯ]',
